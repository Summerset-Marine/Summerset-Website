...
export default function MadisonTestimonialsPage() {
  ...
  return (
    <Layout>
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          <h1 className="font-serif text-4xl md:text-5xl">
            What Lake Mendota Homeowners Say
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Hear from waterfront property owners across the Madison market who trusted
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        {testimonials.length > 0 ? (
          ...
          <div>
            ...
            <ContentPlaceholder
              label="Lake Mendota customer testimonials — quotes, names, lake labels, star ratings (from Sanity)"
              className="mt-8"
            />
          </div>
        )}
      ...
      <CTABlock
        ...
        subheadline="Request a consultation and see why Madison customers choose Summerset Marine."
        primaryCta={{
