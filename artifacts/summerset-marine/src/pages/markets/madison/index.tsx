    ...
    <Layout>
      ...
      <div className="bg-brand-offwhite px-6 md:px-30 py-3 border-b border-brand-border">
        <div className="mx-auto max-w-content flex items-center gap-2">
          ...
          <span className="font-serif text-xs text-brand-black">{content?.marketName || "Madison"}</span>
        </div>
      </div>
      ...
      <section className="relative h-[75vh] min-h-[540px] overflow-hidden bg-brand-navy">
        <img 
          src={heroImage} 
          alt={content?.heroImageAlt ?? "Madison"} 
      ...
      <section className="bg-brand-offwhite px-6 md:px-30 py-22">
        <div className="mx-auto max-w-content grid md:grid-cols-[1fr_1px_1fr] gap-18 items-start">
          <div>
            ...
            <h2 className="font-serif text-[42px] font-normal leading-[1.1] text-brand-black mb-5">Building in<br/><em className="italic">{content?.marketName || "Madison"}.</em></h2>
          ...
          <div className="flex flex-col gap-10">
            <div>
              <h3 className="font-serif text-2xl text-brand-navy mb-3">New & Used Piers</h3>
              <p className="font-serif text-[15px] leading-[1.8] text-brand-black/70">Stop by our facility to see one of the largest selections of new and used docks and piers available. Along with a variety of pre-owned options, we offer our premium Lifetime All Seasons, Minimalist, and Classic piers.</p>
            </div>
            <div>
              <h3 className="font-serif text-2xl text-brand-navy mb-3">Functional Accessories</h3>
              <p className="font-serif text-[15px] leading-[1.8] text-brand-black/70">During the fabrication of your custom Lifetime Pier, you can select from a range of accessories that are built to perfectly match your pier, using the same high-quality aluminum and HDPE decking.</p>
            </div>
          </div>
        </div>
      </section>
