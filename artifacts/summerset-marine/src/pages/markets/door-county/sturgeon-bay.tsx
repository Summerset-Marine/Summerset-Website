    ...
    <Layout>
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          Summerset Marine on Sturgeon Bay
        </h2>
        <ContentPlaceholder
          label="Sturgeon Bay lake stats (average depth, square acres)"
          className="mt-4"
        />
        {content?.historyText ? (
          ...
          <ContentPlaceholder
            label="years of experience, notable projects, installed base on Sturgeon Bay"
            className="mt-6"
          />
        )}
      </section>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">
            Building on Sturgeon Bay: What Property Owners Should Know
          </h2>
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          Recommended Systems for Sturgeon Bay
        </h2>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">Sturgeon Bay Projects</h2>
          {projects.length > 0 ? (
            ...
            <ContentPlaceholder
              label="Sturgeon Bay project gallery photos (from Sanity projects, lake = sturgeon-bay)"
              className="mt-8"
            />
          )}
          <div className="mt-8">
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          What Sturgeon Bay Homeowners Say
        </h2>
        {testimonials.length > 0 ? (
          ...
          <ContentPlaceholder
            label="Sturgeon Bay customer testimonials (from Sanity testimonials, lake = sturgeon-bay)"
            className="mt-8"
          />
        )}
      </section>
