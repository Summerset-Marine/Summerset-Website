...
export default function DoorCountyTestimonialsPage() {
  ...
  return (
    <Layout>
      ...
      <section className="bg-brand-offwhite text-brand-black border-b border-brand-hairline">
        <div className="mx-auto max-w-content px-6 py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg text-brand-black/70">
            Hear from waterfront property owners across the Door County market who trusted
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        {testimonials.length > 0 ? (
          ...
          <div>
            ...
            <ContentPlaceholder
              label="Door County customer testimonials — quotes, names, lake labels, star ratings (from Sanity)"
              className="mt-8"
            />
          </div>
        )}
      ...
      <CTABlock
        ...
        subheadline="Request a consultation and see why Door County homeowners choose Summerset Marine."
        primaryCta={{
