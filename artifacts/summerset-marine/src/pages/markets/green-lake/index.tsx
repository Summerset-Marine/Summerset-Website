    ...
    <Layout>
      ...
      <div className="bg-brand-offwhite px-6 md:px-30 py-3 border-b border-brand-border">
        <div className="mx-auto max-w-content flex items-center gap-2">
          ...
          <span className="font-serif text-xs text-brand-black">{content?.marketName || "Green Lake"}</span>
        </div>
      </div>
      ...
      <section className="relative h-[75vh] min-h-[540px] overflow-hidden bg-brand-navy">
        <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover object-center">
          <source src="/videos/market-green-lake.mp4" type="video/mp4" />
        </video>
      ...
      <section className="bg-brand-offwhite px-6 md:px-30 py-22">
        <div className="mx-auto max-w-content grid md:grid-cols-[1fr_1px_1fr] gap-18 items-start">
          <div>
            ...
            <h2 className="font-serif text-[42px] font-normal leading-[1.1] text-brand-black mb-5">Building in<br/><em className="italic">{content?.marketName || "Green Lake"}.</em></h2>
          ...
          <div className="flex flex-col gap-10">
            <div>
              <h3 className="font-serif text-2xl text-brand-navy mb-3">Lifts & Piers</h3>
              <p className="font-serif text-[15px] leading-[1.8] text-brand-black/70">Our boat lifts are designed to protect your investment. We also offer Lifetime All Seasons Piers which stay in the water all year, eliminating seasonal installation and removal costs.</p>
            </div>
            <div>
              <h3 className="font-serif text-2xl text-brand-navy mb-3">Seasonal Work</h3>
              <p className="font-serif text-[15px] leading-[1.8] text-brand-black/70">Tired of the seasonal hassle with your old wood pier? Our new Green Lake location offers professional pier installation and removal services designed to save you time and effort.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-brand-offwhite px-6 md:px-30 pb-22 border-t border-brand-border">
        <div className="mx-auto max-w-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-brand-border border border-brand-border">
            {[
              { name: "Green Lake", desc: "Permanent and seasonal pier systems, boat lifts, and full seasonal service on Green Lake, Wisconsin." },
            ].map(lake => (
