...
const LAKE_FILTERS = ["All", "Green Lake"] as const;
...
export default function GreenLakeProjectsPage() {
  ...
  useEffect(() => {
    ...
    sanityLiveFetch<Project[]>(MARKET_PROJECTS_QUERY, { market: "green-lake" })
    ...
    <Layout>
        ...
        .map((p) => (
          <JsonLd
            ...
            data={imageObjectSchema({
              ...
              lake: p.lake === "green-lake" ? "Green Lake" : (p.lake ?? "Green Lake"),
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          <h1 className="font-serif text-4xl md:text-5xl">Green Lake Projects</h1>
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Completed permanent piers, boat lifts, and waterfront systems built by Summerset
            Marine across the Green Lake market.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-content px-6 py-12">
        ...
        {projects === null ? (
          ...
          <div className="mt-10">
            ...
            <ContentPlaceholder
              label="Green Lake project photos, captions, and install years (from Sanity projects)"
              className="mt-8"
            />
          </div>
        ) : (
