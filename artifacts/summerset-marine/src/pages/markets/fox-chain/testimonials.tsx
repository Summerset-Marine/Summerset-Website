...
export default function FoxChainTestimonialsPage() {
  ...
  return (
    <Layout>
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          <h1 className="font-serif text-4xl md:text-5xl">
            What Fox Chain O’ Lakes Homeowners Say
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Hear from waterfront property owners across the Fox Chain market who trusted
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        {testimonials.length > 0 ? (
          ...
          <div>
            ...
            <ContentPlaceholder
              label="Fox Chain O’ Lakes customer testimonials — quotes, names, lake labels, star ratings (from Sanity)"
              className="mt-8"
            />
          </div>
        )}
      ...
      <CTABlock
        ...
        subheadline="Request a consultation and see why Fox Chain customers choose Summerset Marine."
        primaryCta={{
