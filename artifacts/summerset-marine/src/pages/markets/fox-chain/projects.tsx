...
const LAKE_FILTERS = ["All", "Fox Chain O’ Lakes"] as const;
...
export default function FoxChainProjectsPage() {
  ...
  useEffect(() => {
    ...
    sanityLiveFetch<Project[]>(MARKET_PROJECTS_QUERY, { market: "fox-chain" })
        ...
        .map((p) => (
          <JsonLd
            ...
            data={imageObjectSchema({
              ...
              lake: p.lake === "fox-chain" ? "Fox Chain O’ Lakes" : (p.lake ?? "Fox Chain O’ Lakes"),
      ...
      <section className="mx-auto max-w-content px-6 py-12">
        ...
        {projects === null ? (
          ...
          <div className="mt-10">
            ...
            <ContentPlaceholder
              label="Fox Chain project photos, captions, and install years (from Sanity projects)"
              className="mt-8"
            />
          </div>
        ) : (
