...
export default function GenevaLakePage() {
  ...
  return (
    <Layout>
      ...
      <HeroSection
          variant="full-bleed"
          headline="Permanent Piers & Lifts on Geneva Lake"
          subheadline={content?.historyText ?? undefined}
          primaryCta={{
            label: "Request a Consultation on Geneva Lake",
            href: "/markets/lake-geneva/contact",
          }}
          imageSrc={content?.heroImageUrl ?? "/images/smc/lake-geneva-geneva-lake-permanent-pier-aerial-001.jpg"}
          imageAlt={content?.heroImageAlt ?? "Permanent pier aerial view on Geneva Lake, Lake Geneva, Wisconsin — Summerset Marine Construction"}
        />

      {/* 2. SMC on Geneva Lake */}
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          Summerset Marine on Geneva Lake
        </h2>
        <p className="mt-4 text-lg text-brand-gray">
          <strong className="text-brand-navy">Geneva Lake, Wisconsin</strong> &mdash; Average
          Depth: 61 Feet &middot; Square Acres: 5,401
        </p>
        {content?.historyText ? (
          ...
          <ContentPlaceholder
            label="years of experience, notable projects, installed base on Geneva Lake"
            className="mt-6"
          />
        )}
      </section>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">
            Building on Geneva Lake: What Property Owners Should Know
          </h2>
      ...
      {/* 4. Products for Geneva Lake */}
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          Recommended Systems for Geneva Lake
        </h2>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">Geneva Lake Projects</h2>
          {projects.length > 0 ? (
            ...
            <ContentPlaceholder
              label="Geneva Lake project gallery photos (from Sanity projects, lake = geneva-lake)"
              className="mt-8"
            />
          )}
          <div className="mt-8">
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        ...
        {testimonials.length > 0 ? (
          ...
          <ContentPlaceholder
            label="Geneva Lake customer testimonials (from Sanity testimonials, lake = geneva-lake)"
            className="mt-8"
          />
        )}
      </section>
