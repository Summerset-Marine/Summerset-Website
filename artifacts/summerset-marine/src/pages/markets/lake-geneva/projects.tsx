...
const LAKE_FILTERS = ["All", "Geneva Lake"] as const;
...
function matchesLake(project: Project, filter: string): boolean {
  ...
  return lake.includes("geneva");
}

export default function LakeGenevaProjectsPage() {
  ...
  useEffect(() => {
    ...
    sanityLiveFetch<Project[]>(MARKET_PROJECTS_QUERY, { market: "lake-geneva" })
    ...
    <Layout>
        ...
        .map((p) => (
          <JsonLd
            ...
            data={imageObjectSchema({
              ...
              lake: p.lake === "geneva-lake" ? "Geneva Lake" : (p.lake ?? "Geneva Lake"),
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          <h1 className="font-serif text-4xl md:text-5xl">Lake Geneva Projects</h1>
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Completed permanent piers, boat lifts, and waterfront systems built by Summerset
            Marine across the Lake Geneva market.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-content px-6 py-12">
        ...
        {projects === null ? (
          ...
          <div className="mt-10">
            ...
            <ContentPlaceholder
              label="Lake Geneva project photos, captions, and install years (from Sanity projects)"
              className="mt-8"
            />
          </div>
        ) : (
