...
export default function OconomowocTestimonialsPage() {
  ...
  return (
    <Layout>
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Hear from waterfront property owners across the Oconomowoc / Lake Country market who trusted
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        {testimonials.length > 0 ? (
          ...
          <div>
            ...
            <ContentPlaceholder
              label="Oconomowoc / Lake Country customer testimonials — quotes, names, lake labels, star ratings (from Sanity)"
              className="mt-8"
            />
          </div>
        )}
      ...
      <CTABlock
        ...
        subheadline="Request a consultation and see why Lake Country homeowners choose Summerset Marine."
        primaryCta={{
