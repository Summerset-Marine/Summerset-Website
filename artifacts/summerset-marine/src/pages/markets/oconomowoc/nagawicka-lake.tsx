...
export default function NagawickaLakePage() {
  ...
  return (
    <Layout>
      <PageMeta
        title="Permanent Pier Installation on Nagawicka Lake, WI | Summerset Marine"
        description="Summerset Marine Construction installs luxury permanent piers and boat lifts on Nagawicka Lake. Expert waterfront contractors serving Lake Country property owners."
      ...
      {content?.heroImageUrl ? (
        <HeroSection
          variant="full-bleed"
          headline="Permanent Piers & Lifts on Nagawicka Lake"
          ...
          imageAlt={content.heroImageAlt ?? "Permanent pier on Nagawicka Lake"}
        />
      ) : (
        <section className="bg-brand-navy text-white">
          <div className="mx-auto max-w-content px-6 py-20">
            ...
            <ContentPlaceholder
              label="Nagawicka Lake hero subheadline"
              className="mt-6 max-w-2xl"
            />
            <div className="mt-8">
              <Button href="/markets/oconomowoc/contact" variant="primary" size="large">
                Request a Consultation on Nagawicka Lake
              </Button>
            </div>
            <ContentPlaceholder label="Nagawicka Lake hero image" className="mt-10" />
          </div>
        </section>
      )}
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        ...
        {content?.historyText ? (
          ...
          <ContentPlaceholder
            label="years of experience, notable projects, installed base on Nagawicka Lake"
            className="mt-6"
          />
        )}
      </section>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">
            Building on Nagawicka Lake: What Property Owners Should Know
          </h2>
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          Recommended Systems for Nagawicka Lake
        </h2>
      ...
      <section className="bg-brand-offwhite">
        <div className="mx-auto max-w-content px-6 py-16">
          <h2 className="font-serif text-3xl text-brand-navy">Nagawicka Lake Projects</h2>
          {projects.length > 0 ? (
            ...
            <ContentPlaceholder
              label="Nagawicka Lake project gallery photos (from Sanity projects, lake = nagawicka-lake)"
              className="mt-8"
            />
          )}
          <div className="mt-8">
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        <h2 className="font-serif text-3xl text-brand-navy">
          What Nagawicka Lake Homeowners Say
        </h2>
        {testimonials.length > 0 ? (
          ...
          <ContentPlaceholder
            label="Nagawicka Lake customer testimonials (from Sanity testimonials, lake = nagawicka-lake)"
            className="mt-8"
          />
        )}
      </section>
