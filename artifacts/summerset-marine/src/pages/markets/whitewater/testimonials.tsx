...
export default function WhitewaterTestimonialsPage() {
  ...
  return (
    <Layout>
      ...
      <section className="mx-auto max-w-content px-6 py-16">
        {testimonials.length > 0 ? (
          ...
          <div>
            ...
            <ContentPlaceholder
              label="Whitewater area lakes customer testimonials — quotes, names, lake labels, star ratings (from Sanity)"
              className="mt-8"
            />
          </div>
        )}
      ...
      <CTABlock
        ...
        subheadline="Request a consultation and see why Whitewater customers choose Summerset Marine."
        primaryCta={{
