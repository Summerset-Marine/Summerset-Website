...
const LAKE_FILTERS = ["All", "Whitewater area lakes"] as const;
...
export default function WhitewaterProjectsPage() {
  ...
  useEffect(() => {
    ...
    sanityLiveFetch<Project[]>(MARKET_PROJECTS_QUERY, { market: "whitewater" })
    ...
    <Layout>
        ...
        .map((p) => (
          <JsonLd
            ...
            data={imageObjectSchema({
              ...
              lake: p.lake === "delavan-lake" ? "Whitewater area lakes" : (p.lake ?? "Whitewater area lakes"),
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-content px-6 py-16">
          <h1 className="font-serif text-4xl md:text-5xl">Whitewater Projects</h1>
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Completed permanent piers, boat lifts, and waterfront systems built by Summerset
            Marine across the Whitewater market.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-content px-6 py-12">
        ...
        {projects === null ? (
          ...
          <div className="mt-10">
            ...
            <ContentPlaceholder
              label="Whitewater project photos, captions, and install years (from Sanity projects)"
              className="mt-8"
            />
          </div>
        ) : (
                  ...
                  <div className="p-5">
                    <div className="flex flex-wrap gap-2">
                      <span className="rounded bg-brand-navy px-2 py-1 text-xs font-semibold uppercase tracking-wide text-white">
                        {project.lake === "delavan-lake"
                          ? "Whitewater area lakes"
                          : (project.lake ?? "Whitewater area lakes")}
                      </span>
                      {project.productType ? (
